...
![maquininha\_realizar\_venda\_1](../../.gitbook/assets/maquininha_realizar_venda_1.png)

**Passo 1 -** Para iniciar uma venda, na tela inicial, clique no botão "<mark style="color:orange;">Confirmar</mark>".

<br>

![maquininha\_realizar\_venda\_2](../../.gitbook/assets/maquininha_realizar_venda_2.png)

**Passo 2 -** Digite o valor da venda utilizando o teclado numérico, após isso, clique em "<mark style="color:orange;">Confirmar</mark>".

![maquininha\_realizar\_venda\_3](../../.gitbook/assets/maquininha_realizar_venda_3.png)
...
![maquininha\_realizar\_venda\_4](../../.gitbook/assets/maquininha_realizar_venda_4.png)
