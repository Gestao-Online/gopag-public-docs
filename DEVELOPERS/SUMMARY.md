...
### Vendedores
* [Listar Vendedores](cadastro/vendedores/listar.md)
* [Buscar por CPF/CNPJ](cadastro/vendedores/buscar-cpf-cnpj.md)
* [Detalhes do Vendedor](cadastro/vendedores/detalhes.md)
* [Códigos MCC](cadastro/vendedores/mcc.md)
...
* [Detalhes da Transação](transacoes/detalhes.md)
...
* [Boleto/Bolepix](transacoes/criar/api/boleto.md)

### Criar Transação - Payment Locales (Dispositivos)
